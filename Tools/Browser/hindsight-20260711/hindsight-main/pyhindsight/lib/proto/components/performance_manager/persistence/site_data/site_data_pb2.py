...
# source: components/performance_manager/persistence/site_data/site_data.proto
...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    1,
    '',
    'components/performance_manager/persistence/site_data/site_data.proto'
)
